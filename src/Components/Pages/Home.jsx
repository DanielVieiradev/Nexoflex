  ...
  <section className={styles.leadersSection}>
        <Container>
          ...
          <div className={styles.leadersHeader}>
            <h2>
              Por que o Nexoflex é a <span className={styles.highlight}>escolha dos Líderes?</span>
            </h2>
            <p>
              Controle, organização e praticidade hora a hora. Acompanhe o crescimento 
              dos seus projetos de forma rápida e segura.
            </p>
          </div>
            ...
            <div className={styles.whiteCard}>
              <div className={styles.cardIcon}>
                <svg width="60" height="60" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                   ...
                   <path d="M18 15L18 12" stroke="#0f8a56" strokeWidth="2" strokeLinecap="round"/>
                   <path d="M22 15L22 10" stroke="#0f8a56" strokeWidth="2" strokeLinecap="round"/>
                </svg>
              </div>
